...
public class AudioManager : MonoBehaviour
{
    ...
    public List<EventReference> references = new();
    ...
    private void Load()
    {
        ...
        {
            CreateInstance(reference.Path.Split('/')[^1], reference);
        }
    }
    ...
    public FMODEventContainer Play(EventReference reference)
    {
        foreach (FMODEventContainer sound in events)
        {
            if (sound.eventReference.Equals(reference))
            {
                sound.Play();
                return sound;
            }
    ...
    public float GetVolume(int id)
    {
        ...
        switch (id)
        {
            ...
            case 1:
                ...
                return value;
            case 2:
                ambienceBus.getVolume(out value);
                return value;
            case 3:
